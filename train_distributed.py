...
#from dataloader.dataset_distributed_idx_cen2 import collate_fn_BEV, Nuscenes_pt, spherical_dataset, collate_dataset_info, SemKITTI_pt # us
...
def main():
    ...
    parser.add_argument('-s', '--seedfix', action="store_true", default=False)  # seed
